...
import { Form, Input, Button, Row, Col, notification, Steps, Select, DatePicker } from 'antd';
...
const PassengerForm = () => {
  ...
  const handleSubmit = async () => {
    ...
    const data = {
      ...
      notification.success({ message: "Passenger details submitted successfully!" });
    } catch (error) {
      ...
      <Form form={form} layout="vertical" onFinish={handleSubmit}>
        ...
        <Row gutter={16}>
          <Col span={12}>
            <Form.Item
              label="First Name"
              name={`firstname_${step}`}
              rules={[{ required: true, message: 'Please enter the first name' }]}
            >
              <Input
                value={passengerDetails[step].firstname}
                onChange={(e) => handleInputChange(step, 'firstname', e.target.value)}
              />
            </Form.Item>
          </Col>
          <Col span={12}>
            ...
            >
              <Input
                ...
                onChange={(e) => handleInputChange(step, 'lastname', e.target.value)}
              />
            </Form.Item>
          </Col>
        </Row>
        <Row gutter={16}>
          <Col span={12}>
            ...
            >
              <DatePicker
                value={passengerDetails[step].dateofbirth ? moment(passengerDetails[step].dateofbirth) : null}
                onChange={(date, dateString) => handleInputChange(step, 'dateofbirth', dateString)}
                format="YYYY-MM-DD"
              />
            </Form.Item>
          </Col>
          ...
          <Col span={12}>
            ...
            >
              <Input
                ...
                onChange={(e) => handleInputChange(step, 'contactnumber', e.target.value)}
                maxLength={10}
              />
            </Form.Item>
          </Col>
          <Col span={12}>
            ...
            >
              <Input
                ...
                onChange={(e) => handleInputChange(step, 'emailaddress', e.target.value)}
              />
            </Form.Item>
          </Col>
        </Row>
          ...
          <Col span={12}>
            ...
            >
              <Input
                ...
                onChange={(e) => handleInputChange(step, 'streetaddr', e.target.value)}
              />
            </Form.Item>
          </Col>
          <Col span={12}>
            ...
            >
              <Input
                ...
                onChange={(e) => handleInputChange(step, 'city', e.target.value)}
              />
            </Form.Item>
          </Col>
        </Row>
          ...
          <Col span={12}>
            ...
            >
              <Input
                ...
                onChange={(e) => handleInputChange(step, 'state', e.target.value)}
              />
            </Form.Item>
          </Col>
          <Col span={12}>
            ...
            >
              <Input
                ...
                onChange={(e) => handleInputChange(step, 'country', e.target.value)}
              />
            </Form.Item>
          </Col>
        </Row>
          ...
          <Col span={12}>
            ...
            >
              <Input
                ...
                onChange={(e) => handleInputChange(step, 'zipcode', e.target.value)}
              />
            </Form.Item>
          </Col>
          <Col span={12}>
            ...
            >
              <Input
                ...
                onChange={(e) => handleInputChange(step, 'nationality', e.target.value)}
              />
            </Form.Item>
          </Col>
        </Row>
          ...
          <Col span={12}>
            ...
            >
              <Input
                ...
                onChange={(e) => handleInputChange(step, 'passportnumber', e.target.value)}
              />
            </Form.Item>
          </Col>
          <Col span={12}>
            ...
            >
              <Input
                ...
                onChange={(e) => handleInputChange(step, 'emergencycontactname', e.target.value)}
              />
            </Form.Item>
          </Col>
        </Row>
          ...
          <Col span={12}>
            ...
            >
              <Input
                ...
                onChange={(e) => handleInputChange(step, 'emergencycontactnumber', e.target.value)}
                maxLength={10}
              />
            </Form.Item>
          </Col>
