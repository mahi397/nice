...
urlpatterns = [
    ...
    path('admin/rooms/add', views.MmsRoomCreateUpdateView.as_view(), name='room-create'),  # Single room creation
    path('admin/rooms/<int:roomnumber>/update', views.MmsRoomCreateUpdateView.as_view(), name='room-update'),  # Single room update
    path('admin/rooms/bulk-create', views.MmsRoomBulkCSVCreateView.as_view(), name='room-bulk-create'),  # Bulk create from CSV
    path('admin/rooms/bulk-update', views.MmsRoomBulkUpdateView.as_view(), name='room-bulk-update'),  # Bulk update via UI
    ...
    path('admin/trips/add', views.MmsTripCreateUpdateView.as_view(), name='add-trips'),
    path('admin/trips/<int:tripid>/update', views.MmsTripCreateUpdateView.as_view(), name='update-trips'),
    ...
    path('admin/port-stops/add', views.MmsPortStopCreateUpdateView.as_view(), name='add-port-stops'),
    path('admin/port-stops/<int:itineraryid>/update', views.MmsPortStopCreateUpdateView.as_view(), name='update-port-stops'),
