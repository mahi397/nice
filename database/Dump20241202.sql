CREATE DATABASE  IF NOT EXISTS `nice` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `nice`;
...
CREATE TABLE mms_activity (
  ...
  activitytype varchar(30) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Type of the activity',
  activityname varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Name of the activity	',
  activity_description varchar(45) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Description of the activity on board the ship.',
...
CREATE TABLE mms_booking (
  ...
  bookingstatus varchar(20) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Status of the booking, e.g., "Confirmed," "Pending," "Canceled." Assists with management tracking.',
...
CREATE TABLE mms_group (
  ...
  groupname varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Name of the group',
  PRIMARY KEY (groupid)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE mms_invoice (
  ...
  paymentstatus varchar(20) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Indicates whether the invoice is "Paid," "Unpaid," or "Overdue." Tracks financial status.',
...
CREATE TABLE mms_package (
  ...
  packagename varchar(30) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Name of the packages offered on the trip',
  base_price decimal(5,2) NOT NULL COMMENT 'Price of the package per person per night',
  packagedetails varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Details of the package',
...
CREATE TABLE mms_passenger (
  ...
  firstname varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Stores the passenger''s first name',
  lastname varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Stores the passenger''s last name',
  dateofbirth datetime NOT NULL COMMENT 'Hold''s the passenger''s birth date',
  gender char(1) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Captures the gender of the passenger',
  contactnumber varchar(10) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'A primary phone number to reach the passenger for notifications, emergencies, or updates related to their trip.',
  emailaddress varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Stores the passenger├ÄΓÇ£├âΓÇí├âΓÇôs email address for electronic communication, including booking confirmations and promotional materials.',
  streetaddr varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'The street address of the passenger''s primary residence, used for correspondence and identification purposes.',
  city varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Represents the passenger''s residential address. This could be useful for billing, mailing tickets, or other physical correspondence.',
  state varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Represents the passenger''s residential address. This could be useful for billing, mailing tickets, or other physical correspondence.',
  country varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Represents the passenger''s residential address. This could be useful for billing, mailing tickets, or other physical correspondence.',
  zipcode varchar(5) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Represents the passenger''s residential address. This could be useful for billing, mailing tickets, or other physical correspondence.',
  nationality varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Records the passenger''s nationality, which may be relevant for certain legal or travel restrictions.',
  passportnumber varchar(20) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Stores the passport number, useful for international cruise trips where passport details are required for customs and immigration checks.',
  emergencycontactname varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'The name of a designated emergency contact who can be notified if needed.',
  emergencycontactnumber varchar(10) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'The contact number for the emergency contact, ensuring quick reachability in case of emergencies during the trip.',
  groupid bigint NOT NULL COMMENT 'Unqiue identifier for every group',
...
CREATE TABLE mms_payment_detail (
  ...
  paymentmethod varchar(20) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Method of payment (e.g., "Credit Card," "Bank Transfer," "Cash"). Provides context for processing.',
  transactionid varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Unique ID from the payment provider for reference. Useful for audits and confirmations.',
...
CREATE TABLE mms_port (
  ...
  portname varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'The name of the port where the cruise either stops during the itinerary or starts/ends the trip. This attribute identifies specific locations included in the trip.',
  address varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Street address where the port is located. ',
  portcity varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Name of the country where the port is located. Useful for regional sorting and queries.',
  portstate varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Name of the state (if applicable) where the port is located. Adds further location specificity.',
  portcountry varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Name of the city where the port is located. Useful for detailed geographical reference.',
  nearestairport varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Name of the nearest airport to the port',
...
CREATE TABLE mms_port_stop (
  ...
  isstartport char(1) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Indicates if the port is starting point of the trip',
  isendport char(1) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Indicates if the port is ending point of the trip',
...
CREATE TABLE mms_restaurant (
  ...
  restaurantname varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Name of the resturant',
  ...
  servesbreakfast char(1) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Value to specify if the restaurant serves breakfast or not. For e.g., ''Y'' for yes and ''N'' for no',
  serveslunch char(1) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Value to specify if the restaurant serves lunch or not. For e.g., ''Y'' for yes and ''N'' for no',
  servesdinner char(1) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Value to specify if the restaurant serves dinner or not. For e.g., ''Y'' for yes and ''N'' for no',
  servesalcohol char(1) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Value to specify if the restaurant serves alcohol or not. For e.g., ''Y'' for yes and ''N'' for no',
  resturant_description varchar(45) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Description of the cuisine served with the restaurant.',
...
CREATE TABLE mms_room_loc (
  ...
  location varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Name of the location in the ship',
  PRIMARY KEY (locid)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE mms_room_type (
  stateroomtypeid smallint NOT NULL COMMENT 'Unique identifier of room type',
  stateroomtype varchar(20) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Name of the stateroom type',
...
CREATE TABLE mms_trip (
  ...
  tripname varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Descriptive name of the trip.',
  ...
  tripstatus varchar(20) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Status of the trip (e.g., upcoming, ongoing, completed).',
  trip_cancellation varchar(10) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Trip cancellation status ‘canceled’.',
  trip_capacity int NOT NULL COMMENT 'Total passenger capacity for the cruise liner.',
  trip_description mediumtext COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Description of the trip booked.',
...
--
-- Dumping events for database 'nice'
--

--
-- Dumping routines for database 'nice'
--
